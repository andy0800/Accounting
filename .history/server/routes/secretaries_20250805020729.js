...
router.post('/', async (req, res) => {
  try {
    ...
    console.log('Creating secretary with data:', { name, email, phone });
    ...
    console.log('Secretary saved successfully:', savedSecretary._id);

    // إنشاء حساب للسكرتيرة - مؤقتاً معطل للاختبار
    /*
    try {
