          ...
          <TableContainer component={Paper} variant="outlined">
            <Table>
                    ...
                    <TableRow>
                      ...
                      <TableCell>سكرتيرة البيع</TableCell>
                      <TableCell>عمولة البيع</TableCell>
                ...
                {visas.map((visa) => (
                  <TableRow key={visa._id}>
                    ...
                    <TableCell sx={{ fontWeight: 'medium', color: 'secondary.main' }}>
                      {visa.sellingCommission && visa.sellingCommission > 0 ? 
                        `${visa.sellingCommission.toLocaleString()} دينار` : '-'}
                    </TableCell>
                    <TableCell>
                      {visa.deadline ? new Date(visa.deadline).toLocaleDateString('en-US') : '-'}
                    </TableCell>
                  </TableRow>
                ))}
              </TableBody>
