...
const NewVisa: React.FC = () => {
  ...
  const validateForm = () => {
    ...
    if (isNaN(percentage) || percentage < 0 || percentage > 100) {
      setError('نسبة ربح السكرتير يجب أن تكون بين 0 و 100');
      return false;
    }
              ...
              <Grid container spacing={3}>
                ...
                <Grid item xs={12} md={6}>
                  <FormControl fullWidth required>
                    <InputLabel id="secretary-label">السكرتير المسؤول</InputLabel>
                    <Select
                      labelId="secretary-label"
                      value={formData.secretaryId}
                      label="السكرتير المسؤول"
