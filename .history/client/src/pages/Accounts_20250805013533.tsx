              ...
              <CardContent>
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={12} sm={6} md={3}>
                    <Box sx={{ textAlign: 'center', p: 2, border: '1px solid #e0e0e0', borderRadius: 1 }}>
                      <Typography variant="h4" color="success.main">
                        {secretaryAccounts.reduce((sum, sa) => sum + sa.statistics.totalEarnings, 0).toLocaleString()} دينار
                      </Typography>
                      <Typography variant="body2" color="textSecondary">
                  ...
                  <Grid item xs={12} sm={6} md={3}>
                    <Box sx={{ textAlign: 'center', p: 2, border: '1px solid #e0e0e0', borderRadius: 1 }}>
                      <Typography variant="h4" color="error">
                        {secretaryAccounts.reduce((sum, sa) => sum + sa.statistics.totalDebt, 0).toLocaleString()} دينار
                      </Typography>
                      <Typography variant="body2" color="textSecondary">
                        ...
                        <TableRow key={secretaryAccount.secretary._id}>
                          ...
                          <TableCell>
                            <Typography color="success.main" fontWeight="bold">
                              {secretaryAccount.statistics.totalEarnings.toLocaleString()} دينار
                            </Typography>
                          </TableCell>
                          <TableCell>
                            <Typography color="error.main" fontWeight="bold">
                              {secretaryAccount.statistics.totalDebt.toLocaleString()} دينار
                            </Typography>
                          </TableCell>
                          <TableCell>
                            <Typography 
                              ...
                              fontWeight="bold"
                            >
                              {(secretaryAccount.statistics.totalEarnings - secretaryAccount.statistics.totalDebt).toLocaleString()} دينار
                            </Typography>
                          </TableCell>
                          <TableCell>
                            <Typography color="info.main">
                              {secretaryAccount.statistics.averageProfitPerVisa.toLocaleString()} دينار
                            </Typography>
                          </TableCell>
                          <TableCell>
                            <Button
