              ...
              <CardContent>
                ...
                <TableContainer component={Paper}>
                  <Table>
                    ...
                    <TableBody>
                      {companyAccount.statistics.companyProfitPerVisa.map((visa) => (
                  ...
                  <Table>
                    <TableHead>
                      <TableRow>
                        ...
                        <TableCell>تاريخ البيع</TableCell>
                        <TableCell>تاريخ انتهاء التأشيرة</TableCell>
                      </TableRow>
                    </TableHead>
                    <TableBody>
                      {console.log('Rendering allBoughtVisas:', companyAccount.statistics.allBoughtVisas)}
                      {companyAccount.statistics.allBoughtVisas?.map((visa) => (
                        <TableRow key={visa.visaId}>
                          <TableCell>{visa.reference}</TableCell>
                          <TableCell>{visa.name}</TableCell>
                          <TableCell>{visa.secretary.name} ({visa.secretary.code})</TableCell>
                          ...
                          <TableCell>{visa.currentStage}</TableCell>
                          <TableCell>{visa.totalExpenses.toLocaleString()} دينار</TableCell>
                          <TableCell>{visa.sellingPrice > 0 ? `${visa.sellingPrice.toLocaleString()} دينار` : '-'}</TableCell>
                          <TableCell>{visa.profit > 0 ? `${visa.profit.toLocaleString()} دينار` : '-'}</TableCell>
                          <TableCell>{visa.secretaryEarnings > 0 ? `${visa.secretaryEarnings.toLocaleString()} دينار` : '-'}</TableCell>
                          <TableCell sx={{ 
                            fontWeight: 'bold', 
