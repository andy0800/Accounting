...
const CompanyAccount: React.FC = () => {
  const [companyAccount, setCompanyAccount] = useState<ICompanyAccount | null>(null);
  ...
  return (
    <Container maxWidth="xl" sx={{ mt: 4, mb: 4 }}>
      ...
      <Box sx={{ mb: 2, p: 1, backgroundColor: 'yellow', border: '2px solid red' }}>
        <Typography variant="body2">
          Debug: Current active tab is: {activeTab}
        </Typography>
      </Box>

      <Box sx={{ borderBottom: 1, borderColor: 'divider', mb: 3, backgroundColor: '#f5f5f5', p: 1 }}>
        <Tabs 
          value={activeTab} 
          ...
          variant="fullWidth"
          aria-label="company account tabs"
        >
      ...
      {/* تبويب الملخص العام */}
      {activeTab === 0 && (
        <Box sx={{ mb: 2, p: 1, backgroundColor: 'lightgreen', border: '2px solid green' }}>
          <Typography variant="body2">
            Debug: Rendering Tab 0 content
          </Typography>
        </Box>
      )}
      {activeTab === 0 && (
      ...
      {activeTab === 1 && (
        <Box sx={{ mb: 2, p: 1, backgroundColor: 'lightblue', border: '2px solid blue' }}>
          <Typography variant="body2">
            Debug: Rendering Tab 1 content
          </Typography>
        </Box>
      )}
      {activeTab === 1 && (
      ...
      {activeTab === 2 && (
        <Box sx={{ mb: 2, p: 1, backgroundColor: 'lightcoral', border: '2px solid red' }}>
          <Typography variant="body2">
            Debug: Rendering Tab 2 content
          </Typography>
        </Box>
      )}
      {activeTab === 2 && (
