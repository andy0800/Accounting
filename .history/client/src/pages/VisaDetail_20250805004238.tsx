...
const VisaDetail: React.FC = () => {
  ...
  const handleCompleteStage = async (stage: string) => {
    try {
      const stageEndpoints = {
        ...
        'هـ': `/api/visas/${id}/complete-buying-process`
      };
  ...
  const canCompleteStage = (stage: string) => {
    ...
    return visa.currentStage === stage && stageExpenses[stage as keyof typeof stageExpenses].length > 0;
  };
            ...
            <Card>
              <CardContent>
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={12} sm={6}>
                    <Typography variant="body2" color="text.secondary">السكرتير المسؤول</Typography>
                  ...
                  <Grid item xs={12} sm={6}>
                    <Typography variant="body2" color="text.secondary">نسبة ربح السكرتير</Typography>
                  ...
                  {visa.status === 'قيد_الشراء' && (
                    <>
                      ...
                      {canCompleteStage(visa.currentStage) && (
                        ...
                        >
                          إكمال المرحلة {visa.currentStage}
                        </Button>
                      )}
                    </>
                  )}
                              ...
                              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
                                ...
                                <Chip 
                                  label={visa.currentStage === stage ? 'حالية' : 
                                        visa.currentStage > stage ? 'مكتملة' : 'قادمة'}
                                  color={visa.currentStage === stage ? 'primary' : 
                                         visa.currentStage > stage ? 'success' : 'default'}
                                  size="small"
                                />
                              </Box>
                        ...
                        <Card variant="outlined">
                          <CardContent>
                            ...
                            <Typography variant="h4" color="error">
                              {visa.totalExpenses.toLocaleString()} ريال
                            </Typography>
                            ...
                            <Card variant="outlined">
                              <CardContent>
                                ...
                                <Typography variant="h4" color="success.main">
                                  {visa.sellingPrice.toLocaleString()} ريال
                                </Typography>
                              </CardContent>
                            </Card>
                          </Grid>
                          ...
                          <Grid item xs={12} md={6}>
                            <Card variant="outlined">
                              <CardContent>
                                ...
                                <Typography variant="h4" color="success.main">
                                  {visa.profit.toLocaleString()} ريال
                                </Typography>
                              </CardContent>
                            </Card>
                          </Grid>
                            ...
                            <Card variant="outlined">
                              <CardContent>
                                ...
                                <Typography variant="h4" color="primary">
                                  {visa.secretaryEarnings.toLocaleString()} ريال
                                </Typography>
                              </CardContent>
                            </Card>
                          </Grid>
                          ...
                          <Grid container spacing={2}>
                            ...
                            <Grid item xs={12} sm={6}>
                              ...
                              <Typography variant="body1">
                                {new Date(visa.soldAt).toLocaleDateString('ar-SA')}
                              </Typography>
                            </Grid>
                          </Grid>
                        </CardContent>
