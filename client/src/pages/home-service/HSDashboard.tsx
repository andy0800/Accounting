    ...
    <Box sx={{ p: 3 }}>
      ...
      <Grid container spacing={3} sx={{ mb: 4 }}>
        <Grid item xs={12} sm={6} md={3}>
          <Card sx={{ background: 'linear-gradient(135deg, #1976d2 0%, #42a5f5 100%)', color: 'white' }}>
            <CardContent>
              ...
              <Typography variant="h4" fontWeight="bold">
                {data.fundingCredit.toLocaleString('en-US', { minimumFractionDigits: 3 })} د.ك
              </Typography>
            </CardContent>
          </Card>
        </Grid>
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Card sx={{ background: 'linear-gradient(135deg, #388e3c 0%, #66bb6a 100%)', color: 'white' }}>
            <CardContent>
              ...
              <Typography variant="h4" fontWeight="bold">
                {data.incomeProfit.toLocaleString('en-US', { minimumFractionDigits: 3 })} د.ك
              </Typography>
            </CardContent>
          </Card>
        </Grid>
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Card sx={{ background: 'linear-gradient(135deg, #d32f2f 0%, #ef5350 100%)', color: 'white' }}>
            <CardContent>
              <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                <DeleteIcon sx={{ fontSize: 40, mr: 1 }} />
                <Typography variant="h6">الفواتير المحذوفة</Typography>
              </Box>
              <Typography variant="h4" fontWeight="bold">
                {data.invoiceCounts.deleted}
              </Typography>
            </CardContent>
          </Card>
        </Grid>
      ...
      <Box sx={{ mb: 4 }}>
        ...
        <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap' }}>
          ...
          <Button
            variant="outlined"
            onClick={() => navigate('/home-service/invoices')}
          >
            عرض جميع الفواتير
          </Button>
          <Button
            variant="outlined"
            onClick={() => navigate('/home-service/accounting')}
          >
            صفحة المحاسبة
          </Button>
        </Box>
